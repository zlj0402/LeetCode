    ...
    + 【思路 1】：滑动窗口
        + 可能会有想不通的地方：
            ...
            + A: 看到 b站 上有个评论很清晰，留了下来，作为回答：
                ...
                连续的子数组。现在 r 位置进来了，那么这次对答案的贡献有哪些？
                那就是以 r 结尾的子数组，这些才是新的、有价值的本轮贡献。
                >>> 不以 r 结尾的，那就已经在他的那一轮算掉了，在此就不能重复计算。<<<
                基于此，以 r 结尾的有 【r】、【r-1, r】...【l+1, r】、【l, r】。
                所以这里有多少个呢，其实等价于 【l, r】 有多少个整数，就等价于 r-l+1。
                举个例子，r=3, l=1，就是 【3】、【3, 2】、【3,2,1】
                + QS: 最重要的是加了 >>> <<< 的地方，细细想来，跟当初做 《Leetcode_15_3sum》时一样，
                       有类似的疑虑，可回顾一下；
